...
function Footer() {
    ...
    const pathNav = `${pathname === '/' || pathname === '/movies' || pathname === '/saved-movies' ? 'footer' : 'footer_type_hidden'}`
            ...
            <div className='footer__container'>
              ...
              <nav>
                <ul className='footer__list'>
                  ...
                  <li className='footer__item'>
                      <a className='footer__link' href='https://github.com/AFrantsuzskaya' target='_blank'>Github</a>
                  </li>
                  <li className='footer__item'>
