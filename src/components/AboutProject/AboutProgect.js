        ...
        <section className='project' id='about-project'>
            ...
            <ul className='project__description'>
                <li className='project__element'>
                    <h3 className='project__description_type_title'>Дипломный проект включал 5 этапов</h3>
                ...
                <li className='project__element'>
                    <h3 className='project__description_type_title'>На выполнение диплома ушло 5 недель</h3>
